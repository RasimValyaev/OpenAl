...
nomenclature_pattern = [
    ...
    (
        r"(\d+(?:[.,]\d+)?)(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)\s*[*]\s*(\d+)(?:\s*(?:pcs|pc|шт|p))?\s*[*]\s*(\d+)",
    ...
    (
        r"(\d+(?:[.,]\d+)?)(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)(\d+)(?:pcs|pc|шт|p)?(\d+)(?:boxes|box|jars|jar|tray|trays|vase|vases|bag|bags)",
        lambda m: (exctract_float(m.group(1)), int(m.group(2)), int(m.group(3))),
    ),
    # Формат с весом в начале и конце (500g ... 500Gx 8Boxes)
    (
        r"(?:^|\s)(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл).*?(\d+)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)\s*[xXхХ*]\s*(\d+)(?:\s|boxes|box|$)",
        lambda m: (exctract_float(m.group(2)), 1, int(m.group(3))),
    ),
    # Формат с запятой или точкой (3,5 GX24X8)
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)[xXхХ*]\s*(\d+)[xXхХ*]\s*(\d+)",
        lambda m: (
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|мл|ml)\s+(\d+)\s*[хХxX]\s*(\d+)\s*(?:бл|блок|boxes|box)",
        lambda m: (
            exctract_float(m.group(1)),
            int(m.group(2)),
            int(m.group(3)),
    ...
    (
        r"(\d+)\s*[xXхХ]\s*(\d+)\s*[xXхХ]\s*(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)(?:\s|$)",
        lambda m: (exctract_float(m.group(3)), int(m.group(2)), int(m.group(1))),
    ),
    # Формат с единицами измерения (100g x 8 pcs x 12tray)
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)\s*[xXхХ×]\s*(\d+)(?:\s*(?:pcs|pc|шт|p))?\s*[xXхХ×]\s*(\d+)",
        lambda m: (
            exctract_float(m.group(1)),
            int(m.group(2)),
            int(m.group(3)),
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)\s*[×]\s*(\d+)(?:\s*(?:pcs|pc|шт|p))?\s*[×]\s*(\d+)",
        lambda m: (
            exctract_float(m.group(1)),
            int(m.group(2)),
            int(m.group(3)),
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|ml|мл)[xXхХ*]\s*(\d+)(?:\s|$)",
    ...
    (
        r"(\d+(?:[.,]\d+)?)(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)\s+(\d+)\s+(\d+)",
        lambda m: (exctract_float(m.group(1)), int(m.group(2)), int(m.group(3))),
    ),
    # Формат Kokolin (12*24*18gr)
    (
        r"(\d+)\s*[*]\s*(\d+)\s*[*]\s*(\d+(?:[.,]\d+)?)(?:g|gr|gx|г|гр|грам|G|GR)",
        lambda m: (exctract_float(m.group(3)), int(m.group(2)), int(m.group(1))),
    ),
    # Формат с пробелами и Х (36гр 12шт Х12бл)
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)\s+(\d+)\s*(?:шт|штХ|шт\s*[xXхХ])\s*[xXхХ]\s*(\d+)\s*(?:бл|блок|блоков)",
        lambda m: (exctract_float(m.group(1)), int(m.group(2)), int(m.group(3))),
    ),
    # Формат с пробелами и слитным штХ (15 гр 20штХ 4бл)
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)\s+(\d+)\s*штХ\s*(\d+)\s*(?:бл|блок|блоков)",
        lambda m: (exctract_float(m.group(1)), int(m.group(2)), int(m.group(3))),
    ),
    # Новый формат для BISCOLATA DUOMAX FINDIKLI 12KT 12AD 44G
    (
        r"(\d+)\s*KT\s*(\d+)\s*AD\s*(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)",
        lambda m: (exctract_float(m.group(3)), int(m.group(2)), int(m.group(1))),
    ),
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*(\d+)\s*(?:шт|шт\s*[xXхХ])\s*[xXхХ]\s*(\d+)",
        lambda m: (
            exctract_float(m.group(1)),
            int(m.group(2)),
            int(m.group(3)),
    ...
    (
        r"(\d+)\s*(?:шт|шт\s*[xXхХ])\s*(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*[xXхХ]\s*(\d+)",
        lambda m: (
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*(\d+)\s*(?:бл|блок|блоков)\s*[xXхХ]\s*(\d+)\s*(?:шт|шт\s*[xXхХ])",
        lambda m: (
            exctract_float(m.group(1)),
            int(m.group(3)),
            int(m.group(2)),
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*[xXхХ]\s*(\d+)\s*(?:шт|шт\s*[xXхХ])\s*[xXхХ]\s*(\d+)",
        lambda m: (
            exctract_float(m.group(1)),
            int(m.group(2)),
            int(m.group(3)),
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*[*]\s*(\d+)\s*(?:шт|шт\s*[*])\s*[*]\s*(\d+)\s*(?:бл|блок|блоков)",
        lambda m: (
            exctract_float(m.group(1)),
            int(m.group(2)),
            int(m.group(3)),
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*[xXхХ]\s*(\d+)\s*[xXхХ]\s*(\d+)",
        lambda m: (
            exctract_float(m.group(1)),
            int(m.group(2)),
            int(m.group(3)),
    ...
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:g|gr|gx|г|гр|грам|G|GR|ml|мл)\s*(\d+)\s*(?:pcs|pc|шт|p)\s*(\d+)\s*(?:box|boxes|бл|блок|блоков)",
        lambda m: (
    ...
    # Паттерн для "Шоколадна фігурка \"Ozmo Go\" 30g з молочного, білого та чорного шоколаду 20шт Х 4бл"
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*(\d+)\s*(?:шт|шт\s*[xXхХ])\s*[xXхХ]\s*(\d+)\s*(?:бл|блок|блоков)",
        lambda m: (exctract_float(m.group(1)), int(m.group(2)), int(m.group(3))),
    ),
    # Паттерн для "Цукерки льодяник на паличці \"AYTOP 3D XXL GUM MIX \" 30 гр. на пластиковому стенді 60 штХ6 стенд"
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*(\d+)\s*(?:шт|шт\s*[xXхХ])\s*[xXхХ]\s*(\d+)\s*(?:стенд|бл|блок|блоков)",
        lambda m: (exctract_float(m.group(1)), int(m.group(2)), int(m.group(3))),
    ),
    # Паттерн для "Цукерки \"Cihan\" 1000гр. X 6шт"
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*[xXхХ]\s*(\d+)\s*(?:шт|шт\s*[.])",
        lambda m: (exctract_float(m.group(1)), 1, int(m.group(2))),
    ),
    # Паттерн для "Цукерки-льодяники на паличці vil pop \"радуга\" круглый вес 16 гр 6*100"
    (
        r"(\d+(?:[.,]\d+)?)\s*(?:г|гр|грам|gr|g|G|GR|ml|мл)\s*(\d+)\s*[*]\s*(\d+)",
        lambda m: (exctract_float(m.group(1)), int(m.group(2)), int(m.group(3))),
    ),
]
