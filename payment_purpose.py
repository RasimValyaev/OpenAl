...
def main():
    ...
    test_texts = [
        """За товар згідно договору №90 від 27.07.20 р  у т.ч. ПДВ 20% - 5526.20 грн.""",
        """Опл.зг.дог. №16760 від 16.02.2021 610: продукти харчуванняв.т.ч. ПДВ - 713.40""",
        """Сплата за товар згідно договору 358П від 28.12.2019, в тч ПДВ 314.42""",
        """ОПЛАТА ЗА АВТОТРАНСП. ПОСЛУГИ ЗГ. РАХ. №СЧТ/R1-0035758 ВIД 19.07.21Р. У сумi 239.17 грн., ПДВ - 20 % 47.83 грн.""",
        """За кондитерськi вироби згiдно договору поставки  N63 вiд 01.04.2020 року У сумi 39741.98 грн., ПДВ - 20 % 7948.40 грн."""
    ]
